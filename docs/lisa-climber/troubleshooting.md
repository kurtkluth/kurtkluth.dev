...
description: Fixes for common problems running Lisa Climber in the browser.
---
...
1. Confirm you can reach [lisaclimber.kluthstudios.com](https://lisaclimber.kluthstudios.com) at all — if not,
...
- If you use a browser extension that captures keyboard shortcuts, try
  disabling it for lisaclimber.kluthstudios.com.

## Progress or high score disappeared

Saved state lives in your browser's local storage for lisaclimber.kluthstudios.com. It is removed if
