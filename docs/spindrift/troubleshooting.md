...
description: Fixes for common problems running Spindrift in the browser.
---
...
1. Confirm you can reach [spindrift.kluthstudios.com](https://spindrift.kluthstudios.com) at all — if not,
...
- If you use a browser extension that captures keyboard shortcuts, try
  disabling it for spindrift.kluthstudios.com.

## Progress or high score disappeared

Saved state lives in your browser's local storage for spindrift.kluthstudios.com. It is removed if
