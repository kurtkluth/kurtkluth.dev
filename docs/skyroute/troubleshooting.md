...
description: Fixes for common problems running Skyroute in the browser.
---
...
1. Confirm you can reach [skyroute.kluthstudios.com](https://skyroute.kluthstudios.com) at all — if not,
...
- If you use a browser extension that captures keyboard shortcuts, try
  disabling it for skyroute.kluthstudios.com.

## Progress or high score disappeared

Saved state lives in your browser's local storage for skyroute.kluthstudios.com. It is removed if
